...
UCLASS(ClassGroup=(SpacehipMovement), meta=(BlueprintSpawnableComponent))
class SPACESHIPMOVEMENT_API USpaceshipGenMovementComponent : public UGenMovementComponent
{
	GENERATED_BODY()
